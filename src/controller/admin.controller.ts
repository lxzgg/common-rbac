...
@Resource({name: 'Resource1', identify: 'Resource1'})
@Controller('admin')
export class AdminController {
  ...
  @Get()
  @Permission({name: 'text', identify: 'text543', action: 'create'})
  text() {
    return 16661
  }

  @Permission({name: 'Permission', identify: 'Permission6422', action: 'create'})
  @Post('addUser')
  ...
  @Permission({name: 'Permission', identify: 'Permission65455', action: 'find'})
  @Post('getUser')
  async getUser() {
